...
# from ..app import NationalWaterLevelForecastBrazil
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_brazil"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_brazil.tests.tests"

        To run tests in the NationalWaterLevelForecastBrazilTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_brazil.tests.tests.NationalWaterLevelForecastBrazilTestCase"

        To run only the test_if_tethys_platform_is_great function in the NationalWaterLevelForecastBrazilTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_brazil.tests.tests.NationalWaterLevelForecastBrazilTestCase.test_if_tethys_platform_is_great"
